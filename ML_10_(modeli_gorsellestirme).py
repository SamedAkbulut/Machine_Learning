...
#sort ederek bunları aylara göre sıralı olarak çizdirdik
#önceden random şekilde çiziyordu
#indexlerine göre sıraladığımız için veriler doğru ve sıralı geliyor


x_train = x_train.sort_index()
y_train = y_train.sort_index()

#şimdi trainde olanları çizdirebiliriz doğru şekilde
plt.plot(x_train,y_train)

#x testte olan değer için ona karşılık gelen tahmini çıkar
plt.plot(x_test,lr.predict(x_test))

#Tablonun ve eksenlerin adlarını yazdırdım
