...
#VERİ BİRLEŞTİRME VE DATFRAME OLUŞTURMA

sonuc= pd.DataFrame(data=ulke,index= range(22), columns=["fr","tr","us"]) 
#ilk 22 satırı al (0dan 21e kadar), sütun başlıklarını yaz
#dizinin indexli olmasını sağladık yani df oldu
print(sonuc)
...
#bütün satırları:; ve sondan 1. sütunu aldık
print(cinsiyet)
